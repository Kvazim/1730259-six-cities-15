# Переделка учебного проекта под современные реалии

#### 1. Внедрение Docker и Docker compose

1 Написание Docker файла и файла Docker compose для локальной разработки
2 Изменение файла конфигурации сборщика для работы в контейнерах
3 Вынесение настроек докера от проекта фронтенда
4 Введение преттер, для написания кода
...
```
git remote add academy git@github.com:htmlacademy-react/1730259-six-cities-15.git
```
